...
def play():
    ...
    Scoreboard = Label(root, text="SCORE \n\n    " + USER.upper() + " - " + str(userWin) + "\t\tCOMPUTER - " + str(compWin), bg='orange',fg='white', padx=10, pady=20)
    ...
    LeaderBoardBtn = Button(buttonHolder, text='Leader Board', fg='black', command=lambda: getLeaderboard(), bg='cyan',
                            width=30, pady=10)
...
def youPick(yourChoice):
    ...
    if counter == turns:
        ...
        confetiImg = PhotoImage(file="Images/confeti.gif")
...
def start():
    ...
    # ----------------Image set----------------
    rHandPhoto = PhotoImage(file='Images/rHand.png')
    pHandPhoto = PhotoImage(file='Images/pHand.png')
    sHandPhoto = PhotoImage(file='Images/sHand.png')
    rock = Image.open("Images/Rockimg.jpg")
    rockImage = ImageTk.PhotoImage(rock)
    paper = Image.open("Images/Paperimg.jpg")
    paperImage = ImageTk.PhotoImage(paper)
    scissors = Image.open("Images/Scissorsimg.jpg")
    scissorImage = ImageTk.PhotoImage(scissors)
    win = Image.open("Images/YouWin.jpg")
    winImage = ImageTk.PhotoImage(win)
    lose = Image.open("Images/YouLose.jpg")
    loseImage = ImageTk.PhotoImage(lose)
    tie = Image.open("Images/YouTie.jpg")
